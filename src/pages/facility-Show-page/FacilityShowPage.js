      ...
      { currentUser ?
        <div>
          ...
          <div className={styles['info-container']}>
            ...
            <h4>3 Months Package <div className={`${styles.price} ${styles['price-margin']}`}>{facility.three_months_package}</div></h4>
            <h4 className={styles['bg-grey']}>6 Months Package <div className={styles.price}>{facility.six_months_package}</div></h4>
            <h4>Annual Package <div className={`${styles.price} ${styles['price-margin']}`}>{facility.annual_package}</div></h4>
